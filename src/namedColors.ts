// CSS named colors (CSS Color 4 <named-color>). Opaque sRGB, packed as 0xRRGGBB.
// Generated from the `color-name` package; do not edit by hand.
...
for (const name in RGB) {
  const v = RGB[name]
  namedColors[name] = newColor((v >> 16) & 0xff, (v >> 8) & 0xff, v & 0xff, 0xff)
}
